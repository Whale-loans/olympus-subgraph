...
export class BUSDBondV1__depositorInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BUSDBondV1__getDepositorInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BUSDBondV1 extends ethereum.SmartContract {
  ...
  depositorInfo(param0: Address): BUSDBondV1__depositorInfoResult {
    let result = super.call(
      "depositorInfo",
    ...
    return new BUSDBondV1__depositorInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_depositorInfo(
    param0: Address
  ): ethereum.CallResult<BUSDBondV1__depositorInfoResult> {
    let result = super.tryCall(
      "depositorInfo",
      "depositorInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new BUSDBondV1__depositorInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getDepositorInfo(address_: Address): BUSDBondV1__getDepositorInfoResult {
    let result = super.call(
      "getDepositorInfo",
    ...
    return new BUSDBondV1__getDepositorInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getDepositorInfo(
    address_: Address
  ): ethereum.CallResult<BUSDBondV1__getDepositorInfoResult> {
    let result = super.tryCall(
      "getDepositorInfo",
      "getDepositorInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(address_)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BUSDBondV1__getDepositorInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
