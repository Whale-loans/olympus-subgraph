...
export class HUMPBUSDBondV3__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class HUMPBUSDBondV3__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV3__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV3 extends ethereum.SmartContract {
  static bind(address: Address): HUMPBUSDBondV3 {
    return new HUMPBUSDBondV3("HUMPBUSDBondV3", address);
  }
  ...
  adjustment(): HUMPBUSDBondV3__adjustmentResult {
    ...
    return new HUMPBUSDBondV3__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_adjustment(): ethereum.CallResult<HUMPBUSDBondV3__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV3__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  bondInfo(param0: Address): HUMPBUSDBondV3__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new HUMPBUSDBondV3__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<HUMPBUSDBondV3__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV3__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  terms(): HUMPBUSDBondV3__termsResult {
    let result = super.call(
      "terms",
    ...
    return new HUMPBUSDBondV3__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<HUMPBUSDBondV3__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV3__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
