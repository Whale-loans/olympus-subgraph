...
export class HUMPBUSDBondV1__depositorInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV1__getDepositorInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV1 extends ethereum.SmartContract {
  ...
  depositorInfo(param0: Address): HUMPBUSDBondV1__depositorInfoResult {
    let result = super.call(
      "depositorInfo",
    ...
    return new HUMPBUSDBondV1__depositorInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_depositorInfo(
    param0: Address
  ): ethereum.CallResult<HUMPBUSDBondV1__depositorInfoResult> {
    let result = super.tryCall(
      "depositorInfo",
      "depositorInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV1__depositorInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getDepositorInfo(
  ...
  ): HUMPBUSDBondV1__getDepositorInfoResult {
    let result = super.call(
      "getDepositorInfo",
    ...
    return new HUMPBUSDBondV1__getDepositorInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getDepositorInfo(
    depositorAddress_: Address
  ): ethereum.CallResult<HUMPBUSDBondV1__getDepositorInfoResult> {
    let result = super.tryCall(
      "getDepositorInfo",
      "getDepositorInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(depositorAddress_)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV1__getDepositorInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  initialize(principleToken_: Address, HUMP_: Address): boolean {
    let result = super.call(
      "initialize",
      "initialize(address,address):(bool)",
      [
        ethereum.Value.fromAddress(principleToken_),
        ethereum.Value.fromAddress(HUMP_)
      ]
    );
