...
export class HUMPBUSDBondV1__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV1__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV1 extends ethereum.SmartContract {
  ...
  adjustment(): HUMPBUSDBondV1__adjustmentResult {
    ...
    return new HUMPBUSDBondV1__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<HUMPBUSDBondV1__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV1__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  terms(): HUMPBUSDBondV1__termsResult {
    let result = super.call(
      "terms",
    ...
    return new HUMPBUSDBondV1__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<HUMPBUSDBondV1__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV1__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
