...
export class BNBBondV1__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BNBBondV1__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BNBBondV1__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BNBBondV1 extends ethereum.SmartContract {
  static bind(address: Address): BNBBondV1 {
    return new BNBBondV1("BNBBondV1", address);
  }
  ...
  adjustment(): BNBBondV1__adjustmentResult {
    ...
    return new BNBBondV1__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<BNBBondV1__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BNBBondV1__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  assetPrice(): BigInt {
    let result = super.call("assetPrice", "assetPrice():(int256)", []);

    return result[0].toBigInt();
  }

  try_assetPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("assetPrice", "assetPrice():(int256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  bondInfo(param0: Address): BNBBondV1__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new BNBBondV1__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<BNBBondV1__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  terms(): BNBBondV1__termsResult {
    ...
    return new BNBBondV1__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<BNBBondV1__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256)",
      []
