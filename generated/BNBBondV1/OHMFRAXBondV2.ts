...
export class HUMPFRAXBondV2__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPFRAXBondV2__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPFRAXBondV2__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPFRAXBondV2 extends ethereum.SmartContract {
  static bind(address: Address): HUMPFRAXBondV2 {
    return new HUMPFRAXBondV2("HUMPFRAXBondV2", address);
  }
  ...
  adjustment(): HUMPFRAXBondV2__adjustmentResult {
    ...
    return new HUMPFRAXBondV2__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<HUMPFRAXBondV2__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new HUMPFRAXBondV2__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): HUMPFRAXBondV2__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new HUMPFRAXBondV2__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<HUMPFRAXBondV2__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPFRAXBondV2__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): HUMPFRAXBondV2__termsResult {
    let result = super.call(
      "terms",
    ...
    return new HUMPFRAXBondV2__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<HUMPFRAXBondV2__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPFRAXBondV2__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
