...
export class HUMPBUSDBondV4__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV4__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV4__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HUMPBUSDBondV4 extends ethereum.SmartContract {
  static bind(address: Address): HUMPBUSDBondV4 {
    return new HUMPBUSDBondV4("HUMPBUSDBondV4", address);
  }
  ...
  adjustment(): HUMPBUSDBondV4__adjustmentResult {
    ...
    return new HUMPBUSDBondV4__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<HUMPBUSDBondV4__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV4__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): HUMPBUSDBondV4__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new HUMPBUSDBondV4__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<HUMPBUSDBondV4__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV4__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): HUMPBUSDBondV4__termsResult {
    let result = super.call(
      "terms",
    ...
    return new HUMPBUSDBondV4__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<HUMPBUSDBondV4__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HUMPBUSDBondV4__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
