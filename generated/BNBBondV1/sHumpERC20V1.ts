...
export class sHumpERC20V1__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sHumpERC20V1 extends ethereum.SmartContract {
  static bind(address: Address): sHumpERC20V1 {
    return new sHumpERC20V1("sHumpERC20V1", address);
  }
  ...
  rebases(param0: BigInt): sHumpERC20V1__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sHumpERC20V1__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(
    param0: BigInt
  ): ethereum.CallResult<sHumpERC20V1__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new sHumpERC20V1__rebasesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
