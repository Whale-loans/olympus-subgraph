...
export class HumpStakingV1Helper extends ethereum.SmartContract {
  static bind(address: Address): HumpStakingV1Helper {
    return new HumpStakingV1Helper("HumpStakingV1Helper", address);
  }
